...
class Sessions extends Table with TableInfo<Sessions, SessionsData> {
  ...
  late final GeneratedColumn<String> arrowsPerEnd = GeneratedColumn<String>(
    'arrows_per_end',
    aliasedName,
    false,
    type: DriftSqlType.string,
...
class SessionsData extends DataClass implements Insertable<SessionsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['arrows_per_end'] = Variable<String>(arrowsPerEnd);
  ...
  factory SessionsData.fromJson(
    ...
    return SessionsData(
      ...
      arrowsPerEnd: serializer.fromJson<String>(json['arrowsPerEnd']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'arrowsPerEnd': serializer.toJson<String>(arrowsPerEnd),
...
class SessionsCompanion extends UpdateCompanion<SessionsData> {
  ...
  final Value<String> arrowsPerEnd;
  ...
  static Insertable<SessionsData> custom({
    ...
    Expression<String>? arrowsPerEnd,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (arrowsPerEnd.present) {
      map['arrows_per_end'] = Variable<String>(arrowsPerEnd.value);
    }
    if (distance.present) {
